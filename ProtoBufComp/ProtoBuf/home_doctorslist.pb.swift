...
///账号密码登录
///请求参数
struct Protogo_GetDoctorsListRequest {
...
///响应参数
struct Protogo_GetDoctorsListResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Protogo_GetDoctorsListRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDoctorsListRequest"
  ...
  static func ==(lhs: Protogo_GetDoctorsListRequest, rhs: Protogo_GetDoctorsListRequest) -> Bool {
...
extension Protogo_GetDoctorsListResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetDoctorsListResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "base"),
    2: .same(proto: "data"),
  ]
  ...
  static func ==(lhs: Protogo_GetDoctorsListResponse, rhs: Protogo_GetDoctorsListResponse) -> Bool {
